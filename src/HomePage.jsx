  ...
  return (
    <div>
      ...
      <div data-aos="flip-up">
        <button className="text-4xl font-pacifico  rounded my-8 mb-0 bg-customRed btn ">
          All Favourites Toys
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 gap-8 m-4">
        {fakedata.map((res) => (
          <div key={res.id}>
            <div
              data-aos="zoom-in"
              className="card card-compact bg-base-100 w-[400px]  shadow-xl"
            >
              <figure>
                <img className=" " src={res.imageUrl} alt="Shoes" />
              </figure>
              <div className="card-body">
                ...
                <div className="card-actions justify-between ">
                  ...
                  <button
                    onClick={() => handleAddcart(res.id)}
                    className="btn bg-customRed "
                  >
                    Add to cart
                  </button>
                </div>
